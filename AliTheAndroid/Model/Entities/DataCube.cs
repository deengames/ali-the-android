...
namespace DeenGames.AliTheAndroid.Model.Entities
{
    public  class DataCube : AbstractEntity
    {
        ...
        {
            // B2
            new Tuple<string, string>("First Day", @"Marbellu Corporation hired me to work on some sort of cure. It's exciting to start working at this space station, because the Qur'an teaches us that saving one life is like saving all of humanity!"),
